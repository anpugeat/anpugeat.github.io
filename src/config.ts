export const siteConfig = {
  ...
  aboutMe:
    "Hi there - thanks for stopping by. If you've already seen my CV, consider this the story behind it.\n\nI'm a STEM graduate shaped by an international academic journey across Beijing, Hong Kong, and London. It was during my degrees that I discovered how much I enjoyed the modules involving data, coding, and machine learning — enough that I kept going on my own, working through material from UCL's MSc in Data Science, Data Engineering, and Machine Learning modules, alongside SQL courses through DataCamp, cloud content from AWS, and other material from accredited platforms.\n\nThat self-directed exploration confirmed what I'd started to suspect: Data is the field I want to build my career in. I'm drawn to the mix of rigorous problem-solving, engineering craft, and the satisfaction of turning messy data into decisions that matter.\n\nTake a look around — I hope what you find here makes the case that I'd be a strong addition to your team."
    ,
